...
conf.calDir = 'data/imagenet_tiny' ;
conf.dataDir = 'data/' ;
...
fprintf(fid,'time train vocabulary(s): %i\n',time_train_voc);
fprintf(fid,'time compute histogram(s): %i\n',time_compute_h);
fprintf(fid,'time train SVM(s): %i\n',time_train_SVM);
fprintf(fid,'time test SVM(s): %i\n',time_test_SVM);
fclose(fid);
% -------------------------------------------------------------------------
